...
| `resources/` | Post-language-check target capacities, descriptor accounting and compiler-admission budgets, before render-ready construction | Syntax admission, rendering or portable arity caps |
