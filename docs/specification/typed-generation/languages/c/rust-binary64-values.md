...
Descriptive owner manifests use version 8 only when defined/imported function
signatures contain f64. All definitions then include parameter/result spellings;
