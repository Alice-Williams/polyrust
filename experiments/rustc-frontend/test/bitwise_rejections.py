...
def main():
    ...
    root.mkdir()
    cases = {
        "u32": ("pub fn value(v: u32) -> u32 { !v }", "signatures require admitted scalar source types", True),
        "i16": ("pub fn value(v: i16) -> i16 { !v }", "signatures require admitted scalar source types", True),
