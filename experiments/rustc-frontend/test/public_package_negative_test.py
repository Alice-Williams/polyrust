...
cases = {
    ...
    "constant_unsupported": (entry + "pub const VALUE: u32 = 1;", "scalar constants support only bool, char, i32, i64 and non-NaN f64"),
    ...
    "u64": ("pub fn wide(value: u64) -> u64 { value }", "signatures require admitted scalar source types"),
    "unit_parameter": ("pub fn empty(value: ()) {}", "signatures require admitted scalar source types"),
    "async": ("pub async fn later() -> i32 { 1 }", "signatures require admitted scalar source types"),
