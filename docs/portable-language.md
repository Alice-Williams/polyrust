...
| String | `concat`, `scalar_len`, `is_empty`, `contains`, `starts_with`, `ends_with` | Unicode scalar semantics; `scalar_len` returns `I64` |
...
| String | scalar slicing, split, replace, trim | Define indices and locale independence |
