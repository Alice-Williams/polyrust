...
readonly compare="$(find "${runfiles}" -path '*/examples/real-world/html-escaper/compare.mjs' -print -quit)"
readonly upstream="$(find "${runfiles}" -path '*/third_party/html-escaper/upstream.js' -print -quit)"
