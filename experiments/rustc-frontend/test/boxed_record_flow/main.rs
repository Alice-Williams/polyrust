//! Pinned compiler driver for boxed scalar-record ownership correspondence.
...
fn main() -> std::process::ExitCode {
    ...
    let compiler_args = vec![
        ...
        args[1].clone(),
        "--crate-type=lib".into(),
        "--crate-name=poly_boxed_record_flow".into(),
        "--edition=2024".into(),
        "-Funsafe-code".into(),
        "-Cpanic=abort".into(),
    ];
    ...
    println!("boxed-record flow correspondence passed");
    status
}
