...
impl Callbacks for Probe {
    fn after_analysis<'tcx>(&mut self, _: &interface::Compiler, tcx: TyCtxt<'tcx>) -> Compilation {
        ...
        provenance_assertions::check(&source);
        provenance_assertions::dependencies(&registry, &source);
...
fn main() -> std::process::ExitCode {
    ...
    println!("compiler declaration, module, visibility, source and docs assertions passed");
