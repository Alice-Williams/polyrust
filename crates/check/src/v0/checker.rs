...
impl Checker<'_> {
    ...
    fn check_intrinsic(
        ...
        use Intrinsic::{
            ...
            FloatDiv, FloatMul, FloatNeg, FloatRemTrunc, FloatSub, Greater, GreaterEqual,
            IntAddChecked, IntAddWrapping, IntBitAnd, IntBitNot, IntBitOr, IntBitXor,
            ...
            StringStartsWith, StringToUtf8, StringTrimEnd, StringTrimStart, WidenI32ToI64,
        };
        ...
        let result = match operation {
            ...
            FloatNeg if arguments == [TypeRef::F64] => Some(TypeRef::F64),
            ...
            StringTrimStart | StringTrimEnd if arguments == [TypeRef::String, TypeRef::String] => {
                Some(TypeRef::String)
            }
