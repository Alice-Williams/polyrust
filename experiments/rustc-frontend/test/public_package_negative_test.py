...
cases = {
    ...
    "u64": ("pub fn wide(value: u64) -> u64 { value }", "only i32, i64, bool and f64"),
    "unit_parameter": ("pub fn empty(value: ()) {}", "only i32, i64, bool and f64"),
    "async": ("pub async fn later() -> i32 { 1 }", "only i32, i64, bool and f64"),
