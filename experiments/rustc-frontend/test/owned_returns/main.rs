//! Pinned compiler proof of explicit source returns and normal owner cleanup.
...
fn main() -> std::process::ExitCode {
    ...
    let compiler_args = vec![
        ...
        args[1].clone(),
        "--crate-type=lib".into(),
        "--crate-name=poly_owned_returns".into(),
        "--edition=2024".into(),
        "-Funsafe-code".into(),
        "-Cpanic=abort".into(),
    ];
    ...
    println!("canonical explicit owned return exits passed");
