...
def main():
    ...
    cases = {
        ...
        "constant": ("pub const VALUE:f64=f64::INFINITY; pub fn value()->f64 {VALUE}", "nonfinite f64 constants", True),
        "local_constant": ("pub fn value()->f64 {const V:f64=f64::INFINITY; V}", "nonfinite f64 constants", True),
