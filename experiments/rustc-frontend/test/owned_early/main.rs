//! Pinned compiler proof of early returns and real enclosing continuations.
...
fn main() -> std::process::ExitCode {
    ...
    let compiler_args = vec![
        ...
        args[1].clone(),
        "--crate-type=lib".into(),
        "--crate-name=poly_owned_early".into(),
        "--edition=2024".into(),
        "-Funsafe-code".into(),
        "-Cpanic=abort".into(),
    ];
    ...
    println!("early owned return and lexical continuation passed");
