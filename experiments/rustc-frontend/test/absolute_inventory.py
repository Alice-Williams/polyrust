...
from absolute_oracle import OPERATIONS, LITERALS
...
def inspect(java_dir, c_dir):
    ...
    names = {leaf: ["abs", "magnitude"], middle: ["relay", "magnitude"],
    ...
    expected_imports = {bindings[leaf, "value", name][1] for name in ["abs", "magnitude"]}
