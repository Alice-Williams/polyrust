//! Pinned source-operation admission and executable record capability proof.
...
mod exit_consumer;
mod fixtures;
#[path = "../owned_record/mapping.rs"]
mod flat_mapping;
#[path = "../../src/inputs.rs"]
mod inputs;
#[path = "../nested_record/mapping.rs"]
mod nested_mapping;
#[allow(dead_code)]
...
#[path = "../nested_owned_probe/trace.rs"]
mod trace;
...
fn main() -> std::process::ExitCode {
    ...
    let compiler_args = vec![
        ...
        args[1].clone(),
        "--crate-type=lib".into(),
        "--crate-name=poly_nested_correspondence".into(),
        "--edition=2024".into(),
        "-Funsafe-code".into(),
        "-Cpanic=abort".into(),
    ];
    ...
    println!("nested correspondence proof passed");
