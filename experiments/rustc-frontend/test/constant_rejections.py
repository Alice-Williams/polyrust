...
def main():
    ...
    cases = {
        ...
        "public_u64": ("pub const VALUE:u64=9007199254740993;",
                       "scalar constants support only bool, i32, i64 and non-NaN f64", True),
        ...
        "public_f32": ("pub const VALUE:f32=4.0; pub fn value()->i32 { 4 }",
                         "scalar constants support only bool, i32, i64 and non-NaN f64", True),
        "local_unsupported": ("pub fn value()->i32 { const VALUE:u32=4; 0 }", "scalar constants support only bool, i32, i64 and non-NaN f64", True),
