...
- [M30 — Compositional target-language IR](milestones/M30-compositional-language-ir.md) — in-progress
...
- [M29 — normalize-newline equivalence port](milestones/M29-normalize-newline.md) — in-progress
