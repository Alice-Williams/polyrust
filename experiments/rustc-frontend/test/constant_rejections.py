...
def main():
    ...
    cases = {
        ...
        "public_u64": ("pub const VALUE:u64=9007199254740993;",
                       "scalar constants support only bool, i32 and i64", True),
        ...
        "public_char": ("pub const VALUE:char='x'; pub fn value()->i32 { 4 }",
                        "scalar constants support only bool, i32 and i64", True),
        "public_float": ("pub const VALUE:f64=4.0; pub fn value()->i32 { 4 }",
                         "scalar constants support only bool, i32 and i64", True),
        ...
        "static": ("static VALUE:i32=4; pub fn value()->i32 { VALUE }",
                   "only resolved local value paths", True),
        "u32": ("const VALUE:u32=4; pub fn value()->u32 { VALUE }", "only i32, i64 and bool", True),
