...
impl Callbacks for Probe {
    fn after_analysis<'tcx>(&mut self, _: &interface::Compiler, tcx: TyCtxt<'tcx>) -> Compilation {
        ...
        documentation_assertions::check(&source);
        ...
        documentation_assertions::rendered(&rendered);
        for _ in 0..2 {
            assert_eq!(
                rendered,
...
fn main() -> std::process::ExitCode {
    ...
    println!("compiler documentation and normalized output assertions passed");
