//! Compiler-only constructor admission and executable binding proof.
...
#[cfg(any(
    owned_contract_missing,
    owned_contract_duplicate,
    owned_contract_wrong_capability,
    owned_contract_wrong_context,
    owned_contract_wrong_output,
    owned_contract_wrong_input,
    owned_contract_private_input
))]
mod contracts;
#[path = "../../src/inputs.rs"]
mod inputs;
...
fn main() -> std::process::ExitCode {
    ...
    let compiler_args = vec![
        ...
        args[1].clone(),
        "--crate-type=lib".into(),
        "--crate-name=poly_owned_construction".into(),
        "--edition=2024".into(),
        "-Funsafe-code".into(),
        "-Cpanic=abort".into(),
    ];
    ...
    println!("typed constructor identities and executable binding passed");
