...
- [M35-03A — Runtime-free C/Java parity and cleanup](tasks/M35-03A-runtime-free-parity.md) — inventory/guards and bounded Boolean/i64/bitwise steps complete; remaining functionality must be implemented before legacy removal
