...
FIXTURE_ALLOWLIST = {
    ...
    "crates/backend-c/test/wrapping_addition_native.py",
    "crates/backend-c/test/wrapping_multiplication_faults.py",
    "crates/backend-c/test/signed_widening.py",
    ...
    "crates/backend-java/test/binary64_remainder.py",
    "crates/backend-java/test/wrapping_addition.py",
    "crates/backend-java/test/signed_widening.py",
...
'''
    ...
    for name in ["binary64_arithmetic.py", "arithmetic_mutations.py", "wrapping_addition_native.py",
                 "wrapping_multiplication_faults.py", "signed_widening.py", "finite_constants.py", "infinite_constants.py"]:
    ...
    for name in ["remainder_native.py", "remainder_stack.py", "remainder_stack_probe.c"]:
        remainder_fixture = "crates/backend-c/test/" + name
        if target_template_offenders(remainder_fixture, "#include <stdint.h>\n"):
            raise AssertionError("test-only remainder fixture was rejected")
        for adjacent in [remainder_fixture + ".copy", "crates/backend-c/src/" + name,
                         "crates/backend-c/test/other_remainder.c"]:
            if not target_template_offenders(adjacent, "#include <stdint.h>\n"):
                raise AssertionError("remainder exception admitted an adjacent template")
    ...
    for name in ["binary64_arithmetic.py", "binary64_remainder.py", "arithmetic_mutations.py", "wrapping_addition.py", "signed_widening.py", "finite_constants.py", "infinite_constants.py"]:
